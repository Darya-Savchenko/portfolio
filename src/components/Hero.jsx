...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <Helmet>
        <title>Daria | Software Developer Portfolio</title>
        <meta name="description" content="Welcome to Daria's portfolio. I am a passionate software developer creating engaging digital experiences." />
      </Helmet>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915eff]">Daria</span>
          </h1>
